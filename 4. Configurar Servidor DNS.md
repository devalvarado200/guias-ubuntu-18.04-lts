...
<p>Imaginemos que las variables x, y, z son los posibles host/subredes</p>
<pre><code>X.0.0.172 
X.Y.0.172
</code></pre>
...
3.1  IN  PTR nfs.technology.com.
3.2  IN  PTR ftp.technology.com.
3.3  IN  PTR mail.technology.com.
